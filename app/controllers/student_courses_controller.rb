class StudentCoursesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @student_course.save
        format.html { redirect_to @student_courses, notice: 'Student course was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @student_course.update(student_course_params)
        format.html { redirect_to student_courses_path, notice: 'Student course was successfully updated.' }
  ...
  private
    ...
    def student_course_params
      params.require(:student_course).permit(:student_id, :course_id, :teacher_id, :state)
    end
end
