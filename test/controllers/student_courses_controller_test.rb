...
class StudentCoursesControllerTest < ActionController::TestCase
  ...
  test "should create student_course" do
    assert_difference('StudentCourse.count') do
      post :create, student_course: { course_id: @student_course.course_id, state: @student_course.state, student_id: @student_course.student_id, teacher_id: @student_course.teacher_id }
    end
  ...
  test "should update student_course" do
    patch :update, id: @student_course, student_course: { course_id: @student_course.course_id, state: @student_course.state, student_id: @student_course.student_id, teacher_id: @student_course.teacher_id }
    assert_redirected_to student_course_path(assigns(:student_course))
  end
